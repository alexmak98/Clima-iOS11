...
class WeatherViewController: UIViewController, CLLocationManagerDelegate, UITableViewDelegate, ChangeCityDelegate{
    
    //Constants
    let WEATHER_URL = "http://api.openweathermap.org/data/2.5/weather"
    let APP_ID = "7fc47575c9d05310ed5a2fb822367f31"
    ...
    func updateWeatherData(json:JSON) {
        ...
        updateUIWithWeatherData()
            ...
            self.cityLabel.text = "Unavailable"
        }
    }
